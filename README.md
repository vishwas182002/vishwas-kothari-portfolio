...
A responsive portfolio with light/dark themes, a directional portrait, 3D project previews, and Creative mode annotations.

## Repository layout

- `index.html`: formatted initial page content.
- `styles.css`: website styles.
- `app.js`: interaction bundle.
- `theme.js`: restores a saved theme before the page renders.
- `fonts/` and portrait images: local assets, with font licenses.
- `resume_vk.pdf`: résumé, preserved from the original website.
- `source/`: editable React source and build instructions.
